    ...
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.headerBanner}>
          <Text style={styles.headerTitle}>Verzon Dairy Farm - Lahore</Text>
        </View>
        ...
        <FarmProducts navigation={navigation} handleAddToCart={handleAddToCart} />
...
const FarmProducts = ({ handleAddToCart }: any) => {
  return (
